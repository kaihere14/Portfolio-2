  ...
  return (
    <div id='skills' className='w-full  flex flex-col py-10 border-b-3 overflow-hidden'>
      ...
      <div className="texts w-full ml-5 lg:ml-15 ">
        ...
        <p className='w-full lg:w-1/3 pt-5 pr-7  font-semibold text-lg text-gray-600 '>The technologies and tools I use to craft clean, modern and responsive digital experiences.</p>
      </div>
